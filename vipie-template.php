...
/*    WE MIGHT WANT TO IMPLEMENT A JS SCROLLBAR... :/     */
    ...
    <body>
        ...
        <div class="paper-container">
            <div class="paper">
		<?php //Original page AKA this vipie frontpage ?>
        ...
        <script>
            $(document).ready(function(){
                ...
                $(".article-container").each(function(){
                    listitems++;
                    listcontentitems+="<li><a href=\"#" + $(this).attr("id") + "\"><div style=\"background: url(" + $(this).attr("thumb") + ") 50% 50% no-repeat; width: 120px; height: 120px; background-size: cover;\"></div></a></li>"
                });
