...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <style>
        ...
        .login-wrapper::before{
            ...
            content:" ";
            display: block;
            background:transparent url('img/anchor-top.png');
            width: 30px;
            height: 15px;
            position: relative;
            left: 50%;
        ...
        .login input, .login input:active{
            background: none;
            border: none;
    ...
    <body>
        ...
        <div class="middle-center">
            <div class="logo">
                <img src="img/vipie200.png" />
            </div>
            <div class="login-wrapper">
                <div class="login">
                    <label for="name">9</label>
                    <input type="text" placeholder="loginnaam" name="name" autofocus/><br />
